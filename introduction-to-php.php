<?php 
//Introduction to PHP - Christina Fairbairn
/*
+---+
| 1 | 
+---+
...
echo "<ul>HTML - Stands for Hypertext Markup Language</ul>";
echo "<ul>CSS - Stands for Cascading Stylesheet</ul>";
echo "<ul>JS - Stands for Javascript</ul>";
echo "<ul>PHP - Stands for Hypertext Preprocessor</ul>";
echo "<ul>SQL - Stands for Structural Query Language</ul>";
?>
